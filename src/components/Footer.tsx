      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <a
              href="#"
              className="flex items-center gap-3 mb-6 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-lg w-fit"
              aria-label="NorthPeak Digital Homepage"
            >
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-600 to-purple-600 p-[1px]">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-blue-500/40 hover:bg-blue-500/10 transition-all"
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          ...
          <div className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-white/[0.04] border border-white/10 text-slate-300">
            <span>Built for Digital Heroes Training Task</span>
            <a
              href="https://digitalheroesco.com"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-400 font-semibold hover:text-cyan-300 hover:underline inline-flex items-center ml-1 group"
            >

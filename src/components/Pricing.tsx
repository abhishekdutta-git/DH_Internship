...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-24 md:py-32 relative bg-[#07090e]">
      {/* Glow Effects */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          {/* Billing Switcher */}
          <div className="inline-flex items-center justify-center bg-white/[0.04] p-1.5 rounded-full border border-white/10 shadow-inner">
            <button
            ...
            return (
              <article
                ...
                className={`rounded-3xl p-8 sm:p-10 flex flex-col justify-between transition-all duration-300 relative ${
                  plan.highlight
                    ? "bg-[#0f172a]/90 gradient-border-glow shadow-2xl shadow-blue-600/20 lg:-translate-y-3"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs sm:text-sm leading-relaxed mb-8 min-h-[40px]">
                    {plan.tagline}
                  </p>
                ...
                <a
                  href="#contact"
                  className={`w-full py-4 px-6 rounded-2xl font-semibold text-sm text-center transition-all duration-300 flex items-center justify-center gap-2 group ${
                    plan.highlight
                      ? "bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white shadow-xl shadow-blue-600/30 hover:shadow-blue-600/50 hover:scale-[1.02]"
